...
- **不**改 `internal/pkg/errors/codes.go`（1002 / 1003 / 1009 全已注册；本 story 仅消费；**不**新增 4xxx 业务错误码 —— 节点 7 阶段 stub 不返业务错误）
...
> 详见 `docs/lessons/2026-05-15-stub-endpoint-explicit-failure.md`。

...
| 2026-05-16 | [开箱前 await in-flight + 自己再 sync 一次的双 sync 是事务正确性 safe choice，不是可消除的浪费（21-5 r1）](2026-05-16-double-sync-before-chest-open-is-transactional-safe-21-5-r1.md) | 1 | architecture | `<pending>` |

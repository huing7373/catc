...
| 2026-05-11 | [UITEST nil-WS-client 路径 nil→A 必须保留 RoomScaffoldDefaults seed roster（r11 unconditional clear 的精化）（12-7 r13）](2026-05-11-uitest-nil-ws-client-must-preserve-scaffold-roster-12-7-r13.md) | 1 | testing | `<pending>` |
| 2026-05-11 | [UseCase stale-success path 必须显式失败（throw error 触发 refresh），不能 silent return 让 client/server desync（12-7 r14）](2026-05-11-stale-usecase-success-must-refresh-not-silently-return-12-7-r14.md) | 1 | architecture | `<pending>` |

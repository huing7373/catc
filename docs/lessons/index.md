...
| 2026-05-08 | [启动期 fail-fast probe 的 if-guard 必须随依赖该资源的 handler 挂载条件同步前移（11-3 r1）](2026-05-08-schema-fail-fast-probe-must-track-handler-mount-condition-11-3-r1.md) | 1 | architecture, fail-fast | `<pending>` |

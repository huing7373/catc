...
| 2026-05-13 | [契约层不绑定 client 渲染器 / array 上限必须有对应 SQL 否则删 / 跨独立 server 路径的事件顺序必为 race window（17-1 r4）](2026-05-13-contract-decouple-client-renderer-and-cap-and-race-window-17-1-r4.md) | 3 | docs, architecture | `<pending>` |
